...
function matrixOperations(){
    // multiply a scalar and a matrix using tensorflow_perceptron.js and log the result
    let scalarMatrixProduct = matrixOne.mul(scalarOne);
    text("matrixSum:" + scalarMatrixProduct.toString(), 730, 50);
    // add two matrices using tensorflow_perceptron.js and log the result
    let matrixSum = matrixOne.add(matrixTwo);
    text("matrixSum:" + matrixSum.toString(), 730, 110);
    // multiply two matrices using tensorflow_perceptron.js and log the result
    let matrixProduct = matrixOne.matMul(matrixTwo);
    text("matrixProduct:" + matrixProduct.toString(), 730, 170);
    // multiply two matrices elementwise using tensorflow_perceptron.js and log the result
